...
import com.abdhilabs.footbalschedule.model.item.League
import com.abdhilabs.footbalschedule.ui.league.detail.DetailLeagueActivity
...
class LeagueAdapter(var league: List<League>) :
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view), LayoutContainer {
        ...
        fun bindItem(league: League) {
            ...
            itemView.setOnClickListener {
                ...
                intent.putExtra(DATA_ID_DETAIL_LEAGUE, league.id)
